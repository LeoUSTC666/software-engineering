...
CREATE TABLE `USER_STUDENT` (
  ...
  FOREIGN KEY (`STUDENT_ID`) REFERENCES `STU_INFO`(`STU_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
INSERT INTO `USER_STUDENT` (`STUDENT_ID`, `STUDENT_NAME`, `STUDENT_NICKNAME`, `STUDENT_PASSWORD`) VALUES ('1', 'Leo', '沧月', '123');
